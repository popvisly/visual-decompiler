                ...
                <main className="flex-1 w-full mx-auto px-6 py-16">
                    {state.phase === 'upload' && (
                        <div className="page-enter max-w-4xl mx-auto">
                            ...
                            <div className="max-w-3xl mx-auto mt-16 opacity-100">
                                <h2 className="text-[#6B6B6B] text-[13px] font-bold uppercase tracking-[0.3em] text-center mb-10">Operational Pipeline</h2>
                                <div className="relative grid grid-cols-1 md:grid-cols-3 gap-0">
                                    ...
                                    {[
                                        ...
                                        <div key={idx} className="text-center px-6 relative pt-4">
                                            <h3 className="text-[12px] font-bold text-[#BB9E7B] uppercase tracking-[0.15em] mb-3">{item.title}</h3>
                                            <p className="text-[14px] text-[#6B6B6B] leading-[1.6] font-medium">{item.desc}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
