...
export default function MarketingSectionHeading({
    ...
    return (
        ...
        >
            ...
            <h2 className="mt-5 max-w-[16ch] text-[clamp(36px,5vw,56px)] font-semibold uppercase leading-[0.9] tracking-tight text-[#141414]">
                {title}
            </h2>
            {description ? (
                <p className="mt-6 max-w-[860px] text-[18px] leading-[1.78] text-[#6B6B6B]">
                    {description}
                </p>
            ) : null}
        </motion.div>
