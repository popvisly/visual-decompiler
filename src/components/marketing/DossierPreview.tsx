...
import { ArrowUpRight, ShieldCheck, Target, Zap, CheckCircle2, AlertTriangle } from 'lucide-react';
    ...
    return (
        <section className="relative bg-[#0D0D0D] text-white py-24 lg:py-40 overflow-hidden" data-presence-tone="dark">
            ...
            <div className="pointer-events-none absolute inset-0 opacity-[0.15]" aria-hidden="true">
                <div className="absolute left-[10%] bottom-[10%] h-[500px] w-[500px] bg-[radial-gradient(circle,rgba(193,166,116,0.12)_0%,rgba(193,166,116,0)_70%)]" />
            </div>
            ...
            <div className="relative z-10 mx-auto max-w-[1400px] px-6 lg:px-12">
                ...
                >
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                        <h2 className="text-[11vw] lg:text-[6vw] font-black leading-[0.82] tracking-[-0.04em] uppercase text-white max-w-[14ch]">
                            What comes <span className="text-[#C1A674]">out is decisive.</span>
                        </h2>
                        <div className="max-w-[440px]">
                            <p className="text-[18px] leading-[1.6] text-white/50 mb-8">
                ...
                {/* Three pillars */}
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-6 mb-20">
                    {PILLARS.map((pillar, idx) => (
                        ...
                        >
                            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-8 lg:p-10">
                                ...
                                <p className="text-[15px] leading-[1.65] text-white/40">
                                    {pillar.detail}
                                </p>
                            </div>
                        </motion.div>
                ...
                >
                    ...
                    <div className="p-8 lg:p-10 space-y-8">
                        {SAMPLE_OUTPUT_LINES.map((line, idx) => (
                            <div key={idx} className="flex flex-col sm:flex-row sm:items-start gap-3 border-b border-white/[0.04] pb-6 last:border-0 last:pb-0">
                                <span className="text-[10px] font-black uppercase tracking-[0.25em] text-white/25 w-[200px] shrink-0 pt-1">
                                    {line.label}
                                </span>
