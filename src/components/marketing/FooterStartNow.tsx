...
export default function FooterStartNow() {
    return (
        <footer className="relative overflow-hidden border-t border-[#2B241A] bg-[#141414] px-6 pb-8 pt-14 text-[#FBFBF6] md:pt-[4.5rem]">
            ...
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(212,165,116,0.08)_0%,transparent_72%)]" />
            <div className="max-w-7xl mx-auto">
                ...
                {/* Footer Links Bar */}
                <div className="flex flex-col items-center justify-between gap-5 border-t border-[#2B241A] px-4 py-5 md:flex-row">
