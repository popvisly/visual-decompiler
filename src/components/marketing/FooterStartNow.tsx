    ...
    return (
        <footer className="border-t border-[#E2D8C8] bg-[#FBFBF6] px-6 pb-8 pt-14 md:pt-[4.5rem]">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Main CTA Section */}
                <div className="relative mb-6 overflow-hidden rounded-[2rem] border border-[#D8CCB5] bg-[radial-gradient(circle_at_top,rgba(212,165,116,0.12),transparent_42%),#FBFBF6] px-8 py-12 md:rounded-[3rem] md:p-14">
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                        ...
                        <div className="w-full flex-shrink-0 lg:w-auto">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.98 }}
                                className={`${HOMEPAGE_PRIMARY_CTA} w-full text-base sm:w-auto sm:px-10 sm:py-5 sm:text-lg`}
                            >
