    ...
    return (
        <section className={`relative overflow-hidden ${LIGHT_SURFACE} ${SECTION_BAND}`}>
            <motion.div {...REVEAL} className="relative z-10 mx-auto max-w-7xl rounded-[2.5rem] border border-[#E2D8C8] bg-[rgba(255,251,244,0.72)] px-6 py-8 shadow-[0_20px_54px_rgba(20,20,20,0.04)] backdrop-blur-[2px] md:px-8 md:py-10">
                ...
                <p className="mt-5 max-w-3xl text-[16px] leading-relaxed text-[#5E5A53] md:text-[18px] font-medium tracking-tight">
                ...
                <div className="mt-8 mx-auto max-w-5xl grid gap-6 lg:grid-cols-2">
                    {/* Asset A */}
                    <div className="group relative overflow-hidden rounded-[3rem] border border-[#D8CCB5] bg-[#FBFBF6] p-3 shadow-[0_18px_40px_rgba(20,20,20,0.06)] sm:p-4">
                ...
                <div className="mt-4 flex items-center justify-center">
                    <span className="rounded-full border border-[#D8CCB5] bg-[#FBFBF6] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4A574] shadow-[0_10px_24px_rgba(20,20,20,0.04)]">
                        Differential Read
                    </span>
                </div>
                ...
                <div className="mt-6 grid gap-3 md:grid-cols-3">
                    {DIFFERENTIAL_METRICS.map((metric, i) => (
                        <motion.div
                            ...
                            className="rounded-xl border border-[#D8CCB5] bg-[#FBFBF6] px-4 py-4 shadow-[0_12px_24px_rgba(20,20,20,0.04)]"
                        >
    ...
    return (
        <section className={`relative overflow-hidden ${LIGHT_SURFACE} ${SECTION_BAND}`}>
            <motion.div {...REVEAL} className="mx-auto max-w-7xl rounded-[2.5rem] border border-[#E2D8C8] bg-[rgba(255,251,244,0.72)] px-6 py-8 shadow-[0_20px_54px_rgba(20,20,20,0.04)] backdrop-blur-[2px] md:px-8 md:py-10">
                ...
                <div className="mt-12 rounded-[1.8rem] border border-[#D8CCB5] bg-transparent px-5 py-5 text-[#141414] md:px-6 md:py-6">
                ...
                <div className="mt-16 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                    {DIFFERENTIATION_BLOCKS.map((block, index) => (
                        <motion.article
                            ...
                            className="group relative flex flex-col overflow-hidden rounded-[2.5rem] border border-[#D8CCB5] bg-[#FBFBF6] shadow-[0_18px_36px_rgba(20,20,20,0.05)]"
                        >
                            <div className="flex items-center gap-3 border-b border-[#E4DACC] px-6 py-5">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-[#D8CCB5] bg-[#FFFDF8]">
                            ...
                            <div className="flex flex-col gap-5 p-6 flex-1">
                                <div className="relative pl-5">
                                    ...
                                    <p className="text-[13px] leading-relaxed text-[#756D61] font-light">
                                        {block.theyDo}
                                    </p>
                                </div>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            {FUNNEL_SECTIONS.map((section, index) => (
                <motion.article
                    ...
                    className="group relative overflow-hidden rounded-[1.7rem] border border-[#D8CCB5] bg-[#FBFBF6] p-4 shadow-[0_14px_30px_rgba(20,20,20,0.05)]"
                >
                    ...
                    <p className="mt-2 max-w-[25ch] text-sm leading-6 text-[#5E5A53]">{STEP_PUNCH[section.id]}</p>
                </motion.article>
            ))}
        </div>
    );
            ...
            <motion.div {...REVEAL} className="relative z-10 mx-auto max-w-7xl">
                <div className="grid gap-10 lg:grid-cols-[1.05fr_0.8fr] lg:items-start lg:gap-12">
                    <div>
                        ...
                        <p className="mt-5 max-w-xl text-[16px] leading-relaxed text-[#5E5A53] md:text-[17px] font-medium tracking-tight">
                        ...
                        <div className="mt-8 grid gap-5 sm:grid-cols-2">
                            <div className="rounded-r-xl border-l-[3px] border-[#D4A574] bg-[#F8F3EA] py-3 pl-6">
                                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4A574] mb-2">Automated Extraction</p>
                                <p className="text-[14px] leading-relaxed text-[#5E5A53]">Hidden signals and subtext surfaced instantly.</p>
                            </div>
                            <div className="rounded-r-xl border-l-[3px] border-[#D4A574] bg-[#F8F3EA] py-3 pl-6">
                                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4A574] mb-2">Strategic Interpretation</p>
                                <p className="text-[14px] leading-relaxed text-[#5E5A53]">Raw data turned into clinical, action-ready moves.</p>
                            </div>
                        </div>
                    </div>
