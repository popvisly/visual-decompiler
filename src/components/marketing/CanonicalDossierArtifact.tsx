...
function shellClass(mode: NonNullable<CanonicalDossierArtifactProps['mode']>) {
    if (mode === 'hero-slice') {
        return 'rounded-[1.4rem] border border-[rgba(193,166,116,0.22)] bg-[#12110F]/75 p-5 backdrop-blur-[2px]';
    }
    if (mode === 'attention-zoom') {
        return 'rounded-[1.9rem] border border-[rgba(193,166,116,0.22)] bg-[#12110F] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.4)] sm:p-8';
    }
    if (mode.startsWith('layer-')) {
        return 'rounded-[1.25rem] border border-[rgba(193,166,116,0.22)] bg-[#12110F] p-5 min-h-[168px]';
    }
    return 'rounded-[2rem] border border-[rgba(193,166,116,0.22)] bg-[#12110F] p-7 shadow-[0_30px_100px_rgba(0,0,0,0.42)] sm:p-9';
}
