...
export default function WhyDifferent() {
    return (
        <section className="relative bg-[#0D0D0D] text-white py-24 lg:py-40 overflow-hidden" data-presence-tone="dark">
            <div className="relative z-10 mx-auto max-w-[1400px] px-6 lg:px-12">
                ...
                <motion.div
                    ...
                    className="mb-20 lg:mb-32 border-t border-white/10 pt-10"
                >
                    <p className="text-[10px] font-black uppercase tracking-[0.45em] text-[#C1A674] mb-6">
                        Category Positioning
                    </p>
                    <h2 className="text-[11vw] lg:text-[6vw] font-black leading-[0.82] tracking-[-0.04em] uppercase text-white max-w-[14ch] mb-10">
                        Every other tool shows you <span className="text-[#C1A674]">what.</span> We read <span className="text-[#C1A674]">why.</span>
                    </h2>
                    <p className="text-[18px] leading-[1.6] text-white/50 max-w-[600px]">
                ...
                <div className="space-y-0">
                    {COMPARISONS.map((comp, idx) => (
                        <motion.div
                            ...
                            className="border-t border-white/6 py-10 lg:py-12 last:border-b last:border-white/6"
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-[0.3fr_0.35fr_0.35fr] gap-8 lg:gap-12">
                                {/* Tool name */}
                                <div>
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="flex items-center justify-center w-10 h-10 rounded-xl border border-white/[0.06] bg-white/[0.02] text-white/30">
                                ...
                                <div>
                                    <div className="mb-4">
                                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#00C853]/60 mb-2">
                                            Does
                                        </p>
                                        <p className="text-[14px] leading-[1.6] text-white/60">{comp.does}</p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#FF5252]/50 mb-2">
                                            Doesn't
                                        </p>
                                ...
                                <div className="flex items-start">
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#C1A674] mb-3">
                                            Visual Decompiler
                                        </p>
                ...
                >
                    <Link
                        href="/ingest"
                        className="group inline-flex items-center gap-3 border-b border-[#C1A674] pb-1 text-[11px] font-black uppercase tracking-[0.2em] text-[#C1A674] transition hover:text-white hover:border-white"
                    >
