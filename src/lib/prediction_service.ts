...
const PREDICTION_STYLE_CONTRACT = [
...
export class PredictionService {
    ...
    static async predictTrends(orgId: string): Promise<TrendPrediction[]> {
        ...
        try {
            ...
            const rawResult = content ? JSON.parse(content) : { predictions: [] };
            const result = normalizeStrategyLanguage(rawResult) as { predictions: any[] };
