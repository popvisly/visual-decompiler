...
export const BLACK_BOX_PROMPT_V1 = [
  ...
  "",
  "- dominant_color_hex must be a 6-character hex string like \"1A2B3C\" (NO #).",
  "- palette_hex must be an array of 3–6 6-character hex strings (NO #), ordered by prominence.",
  "- Include dominant_color_hex as the first item in palette_hex when possible.",
  "- If colors are not reliably estimable, set dominant_color_hex null, palette_hex [], and explain in diagnostics.notes.",
  "",
  "---",
  "",
