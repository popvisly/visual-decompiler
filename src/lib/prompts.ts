...
export const BLACK_BOX_PROMPT_V4 = [
  ...
  "3. **The Evidence Layer (NEW)**:",
  "   - For every major strategic claim, provide visual/textual \"Receipts\".",
  "   - Use normalized coordinates (0-1000) for bounding boxes on the image.",
  "4. **Persuasion Stack (NEW)**:",
  "   - Assign 0-100 weights to triggers based on their dominance.",
  "   - Sequence them in order of attention flow (The Likely Scan Path).",
  ...
  "11. **Reconstruction Strategy**: Generate a high-fidelity image prompt for DALL-E 3 or Midjourney.",
  "12. **Adoption Tier Detection**: Edgy, Trendy, or Mainstream.",
  "",
