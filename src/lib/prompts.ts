...
export const BLACK_BOX_PROMPT_V4 = [
  ...
  "",
  "CRITICAL RULE: You MUST return a flat, completely filled JSON object exactly matching this schema. NEVER omit keys. If a field is not applicable, use null or \"N/A\".",
  "Fields like `target_job_to_be_done`, `objection_tackle`, `primary_headline`, and `notable_visual_elements` MUST be fully populated with rich strategic insights.",
  "",
  "Return exactly this JSON object:",
  "",
  "{",
