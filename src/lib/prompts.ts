...
export const BLACK_BOX_PROMPT_V3 = [
  ...
  "",
  "You must include the `narrative_arc` key within `extraction`:",
  "",
  "```json",
  "{",
  "  \"extraction\": {",
...
export const BLACK_BOX_PROMPT_V4 = [
  ...
  "",
  "Include `ocr_text` in `on_screen_copy` and full `narrative_arc` details:",
  "",
  "```json",
  "{",
  "  \"meta\": {",
  ...
  "    \"product_category_guess\": \"string|null\",",
  "    \"schema_version\": \"2.2\",",
  "    \"aesthetic_year\": \"string\",",
  "    \"historical_genealogy\": \"string\",",
  "    \"adoption_tier\": \"Edgy|Trendy|Mainstream\",",
  "    \"trend_momentum\": 0-100,",
  "    \"predicted_resonance_window\": \"string\"",
  "  },",
  "  \"extraction\": {",
  "    \"on_screen_copy\": {",
