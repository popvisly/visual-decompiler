...
`;
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: `You are the Strategy Copilot for VisualDecompiler.com. Your goal is to analyse the provided creative intel and answer the user's strategic questions.
