...
function CheckItem({ children }: { children: React.ReactNode }) {
    return (
        <li className="flex items-start gap-4 text-sm leading-relaxed">
            <span className="mt-1 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-[#00E5FF]/10 text-[#00E5FF]">
...
export default function PricingPage() {
    ...
    return (
        <main className="min-h-screen bg-[#050505] text-white">
            ...
            {/* Hero Section */}
            <section className="px-6 pt-48 pb-32 lg:pt-64 lg:pb-48">
                <div className="mx-auto max-w-[1400px]">
                    ...
                    >
                        <p className="text-[12px] font-black uppercase tracking-[0.5em] text-[#00E5FF]">
                    ...
                    <motion.h1
                        ...
                        className="text-[10vw] lg:text-[7.5vw] font-black leading-[0.85] tracking-[-0.05em] text-white uppercase max-w-[15ch]"
                    >
                        Start free. <br />
                    ...
                    <motion.p
                        ...
                        className="mt-12 max-w-3xl text-xl lg:text-2xl leading-relaxed text-white/50 font-medium"
                    >
            ...
            <section className="px-6 pb-48">
                <div className="mx-auto max-w-[1440px]">
                    <div className="grid gap-8 lg:grid-cols-4">
                        ...
                        >
                            <div>
                                <Zap className="w-8 h-8 text-[#00E5FF] mb-10" />
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#00E5FF] mb-4">{PRICING.observer.name}</p>
                        ...
                        >
                            <div>
                                <Package className="w-8 h-8 text-[#00E5FF] mb-10" />
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#00E5FF] mb-4">{PRICING.strategic.name}</p>
                                <h3 className="text-6xl font-black tracking-tightest mb-2">${PRICING.strategic.monthlyPrice}</h3>
                                <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#00E5FF] mb-10">Monthly Protocol</p>
                            ...
                            <button
                                ...
                                className="inline-flex w-full items-center justify-center bg-white px-8 pt-6 pb-6 text-[11px] font-black uppercase tracking-[0.3em] text-black transition hover:bg-[#00E5FF] disabled:opacity-50"
                            >
                        ...
                        <motion.article
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.8, ease: EASE, delay: 0.2 }}
                            className="bg-white/10 border border-[#00E5FF]/40 p-10 rounded-[3.5rem] backdrop-blur-3xl flex flex-col justify-between relative"
                        >
                            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#00E5FF] text-black px-6 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.3em] whitespace-nowrap">
                                Highly Recommended
                            </div>
                            <div>
                                <Globe className="w-8 h-8 text-[#00E5FF] mb-10" />
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#00E5FF] mb-4">{PRICING.professional.name}</p>
                                <h3 className="text-6xl font-black tracking-tightest mb-2">${PRICING.professional.monthlyPrice}</h3>
                                <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#00E5FF] mb-10">Unlimited Inbound</p>
                            ...
                            <button
                                ...
                                disabled={loading !== null}
                                className="inline-flex w-full items-center justify-center bg-[#00E5FF] px-8 pt-6 pb-6 text-[11px] font-black uppercase tracking-[0.3em] text-black transition hover:bg-white disabled:opacity-50"
                            >
                        ...
                        >
                            <div>
                                <ShieldCheck className="w-8 h-8 text-[#00E5FF] mb-10" />
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#00E5FF] mb-4">{PRICING.agency.name}</p>
                                ...
                                <blockquote className="my-8 bg-white/5 px-6 py-6 border-l-2 border-[#00E5FF] text-sm leading-relaxed text-white/60 italic">
                            ...
                            <a
                                ...
                                className="inline-flex w-full items-center justify-center border border-[#00E5FF] px-8 pt-6 pb-6 text-[11px] font-black uppercase tracking-[0.3em] text-[#00E5FF] transition hover:bg-[#00E5FF] hover:text-black"
                            >
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-[1000px] w-full border-separate border-spacing-0 rounded-[3rem] border border-white/10 overflow-hidden">
                            <thead className="bg-white/5">
                                <tr>
                                    <th className="px-10 py-8 text-left text-[10px] font-black uppercase tracking-[0.4em] text-[#00E5FF]">System Feature</th>
                            ...
                            <tbody>
                                {PRICING_COMPARISON_ROWS.map((row, index) => (
                                    <tr key={row[0]} className="border-t border-white/5 group bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
                                        ...
                                        <td className="px-10 py-6 border-t border-white/5 text-[14px] text-[#00E5FF] font-black">{row[4]}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
