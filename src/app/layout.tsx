...
export const metadata: Metadata = {
    ...
    description: 'Visual Decompiler deconstructs any ad in under 60 seconds. Uncover persuasion mechanics, silhouette hierarchy, emotional temperature, and reconstruction direction — craft intelligence for working creatives.',
    keywords: [
