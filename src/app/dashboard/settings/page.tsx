    ...
    return (
        <div className="max-w-6xl mx-auto py-16 px-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-20">
                ...
                {/* Preview Col - Centered and Sticky */}
                <div className="xl:col-span-5 relative">
                    <div className="sticky top-12">
                        <p className="text-[10px] font-bold text-[#6B6B6B] uppercase tracking-[0.4em] mb-8 text-center opacity-60 italic">Architectural Preview</p>
                        <div className="bg-[#FBF7EF] rounded-[4.5rem] border-[16px] border-[#141414] shadow-[0_80px_160px_rgba(20,20,20,0.15)] overflow-hidden aspect-[9/18.5] w-full max-w-[340px] mx-auto relative group">

                            {/* Device Shine */}
                            <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/5 to-white/0 pointer-events-none z-10" />

                            <div className="h-20 border-b border-[#E7DED1] bg-white/90 backdrop-blur-md flex items-center px-8">
                                {settings.logo_url ? (
                                    <img src={settings.logo_url} className="h-7 w-auto grayscale transition-all group-hover:grayscale-0" alt="logo" />
                                ) : (
                                    <div className="w-8 h-8 bg-[#141414] rounded-xl flex items-center justify-center text-[11px] font-bold text-white">V</div>
                                )}
                            </div>
                            <div className="p-8 space-y-10">
                                ...
                                />
                                <div className="space-y-6">
                                    <div className="h-6 w-full bg-[#141414]/5 rounded-lg" />
                                    <div className="h-6 w-4/5 bg-[#141414]/5 rounded-lg" />
                                    <div className="h-48 w-full bg-[#141414]/5 rounded-[2.5rem] border border-[#141414]/5" />
                                    <div
                                        className="h-14 w-full rounded-2xl shadow-lg transition-transform animate-pulse"
                                        style={{ backgroundColor: settings.primary_color }}
                                    />
                                </div>
                            </div>
                            ...
                            {/* Home Indicator */}
                            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 w-32 h-1.5 bg-[#141414]/10 rounded-full" />
                        </div>
                    </div>
                </div>
            </div>
